...
public class CubemallExceptionControllerAdvice {
    ...
    public R handleVaildException(RemoteServiceCallExeption remoteServiceCallExeption){
        remoteServiceCallExeption.printStackTrace();
        return R.error(CubemallEnum.REMOTESERVICE_EXCEPTION.getCode(), CubemallEnum.REMOTESERVICE_EXCEPTION.getMsg()).put("data", "未知异常");
    }
}
