...
public class OrderServiceImpl extends ServiceImpl<OrderDao, OrderEntity> implements OrderService {
    ...
    private OrderEntity getOrderbyOrderSn(String orderId) {
        ...
        return this.baseMapper.selectOne(new QueryWrapper<OrderEntity>().eq("order_sn", orderId));
    }
    ...
    private OrderEntity builderOrder(String orderId) {
        ...
        orderEntity.setConfirmStatus(OrderStatusEnum.ORDER_NEW.getCode());
